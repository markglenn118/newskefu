<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/www/wwwroot/chate.uincloud.cn/public/../application/service/view/questions/index.html";i:1632886824;}*/ ?>
						...
						<div class="layui-form-item layui-inline">
							...
							<div class="layui-input-inline">
								<select name="lang">
									...
									<?php $_639716906ddcc=config('lang'); if(is_array($_639716906ddcc) || $_639716906ddcc instanceof \think\Collection || $_639716906ddcc instanceof \think\Paginator): if( count($_639716906ddcc)==0 ) : echo "" ;else: foreach($_639716906ddcc as $key=>$vo): ?>
