<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"C:\Users\13424\Desktop\WWW\kefu\public/../application/index\view\index\index.html";i:1714829877;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
    ...
    <script src="/assets/libs/common.js"></script>
...
<div style="width: 40%;height: 90%;min-height:500px;min-width:500px;margin: 3% auto;position: relative;box-shadow: 0 0 24px 0 rgb(15 66 76 / 25%);margin-left: 23%;">
    ...
    <div id="container"  style="width: 100%;height: 92.3%;position: absolute;top:64px; ">
    <div class="workarea">
        <!--  对话内容部分 -->
...
<div id="xxxx" style="width: 34.9%;height: 100%;position: absolute;top:0px;left: 100%;background: #fff;overflow-x: hidden;border-left:#fff;">
